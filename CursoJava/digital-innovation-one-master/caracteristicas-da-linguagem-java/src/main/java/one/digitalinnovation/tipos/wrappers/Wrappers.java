...
public class Wrappers {
    ...
    public static void main(String[] args) {
        //Autoboxing -> nos exemplos eu passo o valor direto, não coloco new, e o compilador
        // já sabe que precisa autoconstruir esse objeto.

        // Seguem as mesmas regras dos primitivos, mas aqui eu posso atribuir null
